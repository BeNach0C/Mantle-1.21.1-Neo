...
public class BlockTagLootCondition implements LootItemCondition {
  public static final MapCodec<BlockTagLootCondition> CODEC = RecordCodecBuilder.mapCodec(inst ->
      inst.group(
          ResourceLocation.CODEC.xmap(
              loc -> TagKey.create(Registries.BLOCK, loc), TagKey::location
          ).fieldOf("tag").forGetter(c -> c.tag),
