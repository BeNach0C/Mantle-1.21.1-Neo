...
public class MantleFluidTransferProvider extends AbstractFluidContainerTransferProvider {
  ...
  protected void addPotion(String prefix, ItemLike filled, @Nullable TagKey<Item> bottleTag) {
    ...
    ItemStack waterStack = new ItemStack(filled);
    waterStack.set(net.minecraft.core.component.DataComponents.POTION_CONTENTS, new net.minecraft.world.item.alchemy.PotionContents(net.minecraft.world.item.alchemy.Potions.WATER));
    //addTransfer(prefix + "fill_water", new FillFluidContainerTransfer(
    //  container,
    //  ItemOutput.fromStack(waterStack),
