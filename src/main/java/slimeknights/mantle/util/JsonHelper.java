...
public class JsonHelper {
  ...
  public static <T> T convertToEntry(net.minecraft.core.Registry<T> registry, JsonElement element, String key) {
   ...
   */
  @Deprecated(forRemoval = true)
  public static <T> T getAsEntry(net.minecraft.core.Registry<T> registry, JsonObject parent, String key) {
