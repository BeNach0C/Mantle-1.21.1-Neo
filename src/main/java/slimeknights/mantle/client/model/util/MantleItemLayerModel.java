...
public class MantleItemLayerModel implements IUnbakedGeometry<MantleItemLayerModel> {
   ...
   */
  private static net.minecraft.client.renderer.block.model.BakedQuad buildSideQuad(QuadBakingVertexConsumer builder, VertexConsumer consumer, Direction side, int color, TextureAtlasSprite sprite, int u, int v, int size, int luminosity) {
   ...
   * @param luminosity Extra light to add to the quad between 0 and 15
   */
  public static net.minecraft.client.renderer.block.model.BakedQuad buildQuad(QuadBakingVertexConsumer builder, VertexConsumer consumer, Direction side, int color, int luminosity,
  ...
  private static void putVertex(VertexConsumer consumer, Direction side, float x, float y, float z, float u, float v, int color, int luminosity) {
    ...
    consumer.setUv(u, v);
    consumer.setLight(net.minecraft.client.renderer.LightTexture.pack(luminosity, luminosity));
  }
