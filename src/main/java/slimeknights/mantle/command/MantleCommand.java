...
public class MantleCommand {
  ...
  public static void init() {
    ...
    SourcesCommand.register("loot_table", (context, builder)
      -> SharedSuggestionProvider.suggestResource(context.getSource().getServer().registryAccess().registryOrThrow(net.minecraft.core.registries.Registries.LOOT_TABLE).keySet(), builder));
