...
public class MantleClientCommand {
  ...
  public static void init() {
    ...
    ClientSourcesCommand.registerMinecraft("atlases", (context, builder)
      -> SharedSuggestionProvider.suggestResource(java.util.List.of(atlases.fileToId(net.minecraft.client.renderer.texture.TextureAtlas.LOCATION_BLOCKS), atlases.fileToId(net.minecraft.client.renderer.texture.TextureAtlas.LOCATION_PARTICLES)), builder));
