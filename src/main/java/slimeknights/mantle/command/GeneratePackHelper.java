...
public class GeneratePackHelper {
  ...
  public static boolean saveConditionRemove(Path path, String conditionKey) {
    ...
    json.add(conditionKey, net.neoforged.neoforge.common.conditions.ICondition.CODEC.listOf().encodeStart(com.mojang.serialization.JsonOps.INSTANCE, java.util.List.of(FalseCondition.INSTANCE)).getOrThrow());
