...
public interface ICommonRecipeHelper extends IRecipeHelper {
  ...
  default Criterion<TriggerInstance> has(ItemLike itemLike) {
    return net.minecraft.advancements.critereon.InventoryChangeTrigger.TriggerInstance.hasItems(itemLike);
  }

  /** Creates a criterion for having a tag */
  default Criterion<TriggerInstance> has(net.minecraft.tags.TagKey<Item> tag) {
    return net.minecraft.advancements.critereon.InventoryChangeTrigger.TriggerInstance.hasItems(net.minecraft.advancements.critereon.ItemPredicate.Builder.item().of(tag).build());
  }
  ...
  default void woodCrafting(RecipeOutput consumer, WoodBlockObject wood, String folder) {
    net.minecraft.advancements.Criterion<net.minecraft.advancements.critereon.InventoryChangeTrigger.TriggerInstance> hasPlanks = has(wood);
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, wood.getHangingSign(), 6)
                       ...
                       .save(consumer, modResource(folder + "hanging_sign"));
  }
}
